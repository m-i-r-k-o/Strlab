...
/**
 * @brief Function to search for a substring in a 
 * @code{.c}
...
/**
 * @brief Function to insert into a string the strings of a list
 *        delimited by the characters that contains @ref str
 * @code{.c}
